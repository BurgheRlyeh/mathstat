...
def diagram(data, epsilon, beta):
    ...
    plt.xlabel("n")
    plt.ylabel("mV")
    plt.savefig(f"../images/diagram_beta_{beta}.png")
    # plt.show()
...
def parser(lim):
    data = pd.read_csv("../data/Channel_1_700nm_0.2.csv", sep=";", encoding="cp1251")
    ...
    with open(f"../data/Chi{lim}.txt", "w") as f:
...
if __name__ == "__main__":
    ...
    parser(1)
    A1, B1, w1 = load_processed("../data/Chi1.txt")
    print([A1, B1])
    print(np.sum(w1))
    plt.fill_between(
        data.index,
    ...
    plt.xlabel("n")
    plt.ylabel("мV")
    plt.savefig("../images/diagram_and_regress_1.png")
    plt.show()
    plt.close()

    parser(0)
    A0, B0, w0 = load_processed("../data/Chi0.txt")
    print(w0)
    print([A0, B0])
    print(np.sum(w0))
    plt.fill_between(
    ...
    plt.xlabel("n")
    plt.ylabel("мV")
    plt.savefig("../images/diagram_and_regress_0.png")
    plt.show()
    plt.close()
    ...
    plt.xlabel("n")
    plt.ylabel("мV")
    plt.savefig("../images/analysis_of_regression_residuals_1.png")
    plt.show()
    plt.close()
    ...
    plt.xlabel("n")
    plt.ylabel("мV")
    plt.savefig("../images/analysis_of_regression_residuals_0.png")
    plt.show()
    plt.close()
